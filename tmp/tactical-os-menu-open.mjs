...
await page.waitForTimeout(250);
await page.screenshot({ path: 'output/tactical-os-check/context-menu-open.png' });
const result = await page.evaluate(() => JSON.parse(window.render_game_to_text()));
console.log(JSON.stringify({ readout: result.tacticalReadout, menu: result.tacticalContextMenu }, null, 2));
await browser.close();
